...
abstract class Model
{
     ...
     * @return Model|mixed
     */
    public function find(?string $terms = null, ?string $params = null, string $columns = "*", ?string $innerJoin = "")
    {
        if ($terms) {
            $this->query = "SELECT {$columns} FROM {$this->entity} {$innerJoin} WHERE {$terms}";
            parse_str($params, $this->params);
            return $this;
        }

        $this->query = "SELECT {$columns} FROM {$this->entity} {$innerJoin}";
        return $this;
    }
